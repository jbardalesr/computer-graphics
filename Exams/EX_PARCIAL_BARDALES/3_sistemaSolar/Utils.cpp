...
GLuint Utils::loadTexture(const char *texImagePath)
{
	...
	else
	{
		...
		// ------ minimap/anisotropic
		// como opengl es una maquina de estado le indicamos que rederencia a este objeto
		...
		// cada pixel del triangulo le corresponde a un grafico de la textura. Como el grafico esta inclinado es un punto en el grafico 2D, Clase Jueves 13, minuto 20:10. Es la perspectica de la imagen con respecto a la pirámide.
