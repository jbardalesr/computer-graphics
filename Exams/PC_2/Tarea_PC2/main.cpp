...
void display(GLFWwindow *window, double currentTime)
{
    ...
    mvStack.push(vMat);
    {
        ...
        {
            mvStack.top() *= glm::rotate(glm::mat4(1.0f), (float)currentTime / 8.0f, glm::vec3(0, 0.0, 1.0));
            mvStack.push(mvStack.top());
            {
                mvStack.top() *= glm::scale(glm::mat4(1.0f), glm::vec3(3.0f, 4.0f, 0.0f));
            ...
            mvStack.push(mvStack.top());
            {
                ...
                mvStack.top() *= glm::translate(glm::mat4(1.0f), glm::vec3(3.0f, 3.0f, -0.1f));
                mvStack.push(mvStack.top());
                {
                    zrotArm += incArm;
                    if (zrotArm > M_PI / 2.0)
                    ...
                    mvStack.push(mvStack.top());
                    {
                        ...
                        mvStack.top() *= glm::scale(glm::mat4(1.0f), glm::vec3(4.0f, 1.0f, 0.0f));
                    ...
                    mvStack.push(mvStack.top());
                    {
                        ...
                        mvStack.push(mvStack.top());
                        {
                            ...
                            if (zrotForeArm > M_PI / 2.0)
                                incForeArm = -0.005;
                            else if (zrotForeArm < 0)
                                incForeArm = 0.005;
                            ...
                            mvStack.push(mvStack.top());
                            {
                                ...
                                mvStack.top() *= glm::scale(glm::mat4(1.0f), glm::vec3(3.0f, 1.0f, 0.0f));
                            ...
                            mvStack.push(mvStack.top());
                            {
                                ...
                                mvStack.push(mvStack.top());
                                {
                                    ...
                                    mvStack.top() *= glm::scale(glm::mat4(1.0f), glm::vec3(1.5f, 1.0f, 0.0f));
