...
GLuint Utils::loadCubeMap(const char *mapDir) {
	GLuint textureRef;
	string xp = mapDir; xp = xp + "/mountain_west.bmp";
	string xn = mapDir; xn = xn + "/mountain_east.bmp";

	string yp = mapDir; yp = yp + "/mountain_up.bmp";
	string yn = mapDir; yn = yn + "/mountain_down.bmp";

	string zp = mapDir; zp = zp + "/mountain_south.bmp";
	string zn = mapDir; zn = zn + "/mountain_north.bmp";
