...
void display(GLFWwindow *window, double currentTime)
{
    ...
    mMat = glm::translate(glm::mat4(1.0f), glm::vec3(projLocX, projLocY, projLocZ));

    mMat = glm::rotate(mMat, -0.45f, glm::vec3(1.0f, 0.0f, 0.0f));
    mMat = glm::rotate(mMat, 0.00f, glm::vec3(1.0f, 0.0f, 1.0f));

    // El eje de rotacion esta en la base y es perpendicular
